...
The XML class representation is parsed using a serialization library called XStream. XStream maps classes to an XML representation. The classes used to describe the multi language classes are shown in \umlRef{MultiLanguageClassDefinition}.
