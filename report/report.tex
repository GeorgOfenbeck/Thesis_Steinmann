...
Apart from the simple implementation found in 'Numerical Recipes 3rd Edition:
The Art of Scientific Computing' \cite{Press:2007:NRE:1403886} on page 608, we
used the implementations from the MKL \cite{MKL} , FFTW \cite{FFTW}
and Spiral \cite{Spiral}.

\graphFloat{yonah/fft}{Roofline Plot of four FFT implementations}
Figure \ref{yonah/fft} shows the roofline plot of these four implementations.
