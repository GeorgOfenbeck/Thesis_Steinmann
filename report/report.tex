...
To process the results of a measurement, one frequently is interested in the
output of a specific measurer. 
...
ids. But for caching, the ids of the measurers does not matter.
