...
effects of the data access pattern at the same time. To illustrate the point,
...
Using the roofline model we get figure \ref{yonah/intro}. We see
that the operational intensity decreased by an order of magnitude. Reviewing our
modification, we can see that we moved from a row major to a column major access
pattern which is well known to potentially reduce operational intensity. This in
turn 

This is a first example of how the
