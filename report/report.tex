...
The XML class representation is parsed using a serialization library called XStream. XStream maps classes to an XML representation. The serialized classes are shown in the following diagram.

\umlDiagram{MultiLanguageClassDefinition}
