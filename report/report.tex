...
measurement. It is the sole client to the \class{MeasuringCoreService}, which
...
Since it makes sense that services can start measusurements, the
\class{MeasurementService} provides a \method{measure()} method. The service knows an
instance of IMeasurementFacility which provides \method{measure()}, and
