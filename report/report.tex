...
performance on the $y$ axis in a 2D graph (fig. \ref{yonah/overview}). Each
...
The straight forward approach is to use the following loop:
...
to avoid repeated computations of the term $3j^2$:
