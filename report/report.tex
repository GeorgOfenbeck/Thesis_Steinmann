...
During the development of measurement control routines, it is expected that many changes do not affect the parameter points. To avoid the temporal overhead of reperforming all measurements after every minor change, the measurement results are cached.
...
Lists of the supported primitive types as well as of references are supported.
