...
import ch.ethz.ruediste.roofline.multiLanguageCodeGenerator.DOM.FieldType;
import ch.ethz.ruediste.roofline.multiLanguageCodeGenerator.DOM.MultiLangugeFieldBase;

public class SharedFieldBasePMod {
	private MultiLangugeFieldBase sharedFieldBase;
	...
	public SharedFieldBasePMod(MultiLangugeFieldBase sharedFieldBase) {
