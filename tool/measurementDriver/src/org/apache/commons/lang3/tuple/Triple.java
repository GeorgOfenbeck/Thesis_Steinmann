...
public abstract class Triple<L, M, R> implements Comparable<Triple<L, M, R>>,
	...
	public String toString() {
		return new StringBuilder().append('(').append(getLeft()).append(',')
				.append(getMiddle()).append(',').append(getRight()).append(')')
				.toString();
	}
	 ...
	 * {@code %1$s} for the left element, {@code %2$s} for the middle and
	 * {@code %3$s} for the right element. The default format used by
	 * {@code toString()} is {@code (%1$s,%2$s,%3$s)}.
	 * </p>
	 * 
	 * @param format
