...
#include "sharedDOM/TscMeasurerDescription.h"
#include "sharedDOM/TscMeasurerOutput.h"
#include "stdint.h"
class TscMeasurer: public Measurer<TscMeasurerDescription> {
	uint64_t startTime;
	uint64_t endTime;
...
public:
	TscMeasurer(TscMeasurerDescription *desc): Measurer(desc){}
	virtual ~TscMeasurer();
